$DEVELOPER_LANGUAGES = ['Ruby', 'Ruby on Rails', 'Java', 'JavaScript', 'jQuery', 'PHP', 'Python', 'C#', 'C++', 'Vue', 'React', 'React Native', 'Solidity', 'Rust', 'Go', 'Solidity', 'Swift', 'Dart', 'Kotlin', 'Perl', 'Scala'].sort
